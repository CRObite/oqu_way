class AppText{
  ...
  static String register = 'Тіркелу';
  static String cont = 'Жалғастыру';
  static String or = 'НЕМЕСЕ';
  static String continueWithGoogle = 'Google-мен жалғастыру';
  static String enterPasswordAgain = 'Құпиясөзді қайталаңыз';
  static String news = 'Жаңалықтар';
  static String read = 'Оқу';
